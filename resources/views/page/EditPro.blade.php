@extends('Admin')
@section('content')
<form method="post" action="{{route('admin.update',$edit_pro->id)}}">
{{--    <input type="hidden" name="_token" value="{{csrf_token()}}">--}}
    ...
    <div class="container " style="width: 50rem;">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="prod_price" value="{{$edit_pro->promotion_price}}"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="prod_img" value="{{$edit_pro->image}}"/>
        </div>
